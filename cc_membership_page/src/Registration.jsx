  ...
  return (
    <div className="flex flex-col justify-center items-center min-h-screen">
      <div className="h-70 w-70 mx-auto sm:w-96 sm:h-96">
        ...
        <SignUp
        redirectUrl="/submit"
        signInUrl='/loginpanel'
        appearance={{
          layout: {
            logoPlacement: "none"
          },
          elements: {
            socialButtonsBlockButton:'w-[100%] mx-auto mt-6 text-center p-4 rounded py-3 border-2 border-black shadow-custom hover:shadow-none transition-all hover:translate-x-1 translate-y-1 text-2xl font-bold',
